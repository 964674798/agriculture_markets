...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	<td height="227" 
	class="noRepeat"
	background="images/fg_top.jpg"></td>
  </tr>
</table>
    ...
    <TD height="50" align="right" valign="bottom"><IMG src="images/icon_login.gif" align="absmiddle"> 
        ...
        <select id="category">
		  	...
		  	<logic:present name="cateList">
		  		<logic:iterate id="cate" name="cateList" type="tsu.hfq.ORM.Category">
          ...
          <TABLE class="C_Goods_Border" cellSpacing=0 cellPadding=0 width="100%" border=0>
              <TR>
           		...
           		<logic:present name="smerList">
					<logic:iterate id="mer" name="smerList" type="tsu.hfq.ORM.Merchandise">
          ...
          <TABLE class="C_Goods_Border" cellSpacing=0 cellPadding=0 width="100%" border=0>
              <TR>
           		...
           		<logic:present name="merList">
					<logic:iterate id="mer" name="merList" type="tsu.hfq.ORM.Merchandise">
		               <TD valign="top" width="33%">
					 	<table cellspacing=0 cellpadding=0 width=180 border=0>
		                 <tr>
		                   <td align="TOP">
